...
const Header = () => {
  ...
  return (
    <div className="">
      <div className=" w-full flex justify-between mt-[3rem] px-[40px] items-center ">
        <Link to={"/"} className="text-black font-HellixSemiBold text-[20px]">
          Kudina<span className="text-brand">.</span>
        </Link>
        <div className="flex text-[12px] items-center invisible md:visible">
          <ul className="flex">
            <Link to={"/"} className="">
              Services
            </Link>
      ...
      <img
        ...
        alt=""
        className="md:invisible cursor-pointer absolute top-[40px] right-[30px] z-[2]"
      ...
      >
        ...
        <button className=" mt-[20px] border-[0.2px] border-brand rounded-[3px] text-brand py-[5px] px-[15px] hover:bg-brand hover:text-white">
          Get Started
        </button>
      </div>
    </div>
